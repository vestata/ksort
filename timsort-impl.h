...
static void NAME(binarySort)(void *a,
                             size_t hi,
                             size_t start,
                             CMPPARAMS(compare, carg),
                             size_t width);
static size_t NAME(countRunAndMakeAscending)(void *a,
                                             size_t hi,
                                             CMPPARAMS(compare, carg),
                                             size_t width);
...
static size_t NAME(gallopLeft)(void *key,
                               void *base,
                               size_t len,
                               size_t hint,
                               CMPPARAMS(compare, carg),
                               size_t width);
static size_t NAME(gallopRight)(void *key,
                                void *base,
                                size_t len,
                                size_t hint,
                                CMPPARAMS(compare, carg),
                                size_t width);
static int NAME(mergeLo)(struct timsort *ts,
                         void *base1,
                         size_t len1,
                         void *base2,
                         size_t len2,
                         size_t width);
static int NAME(mergeHi)(struct timsort *ts,
                         void *base1,
                         size_t len1,
                         void *base2,
                         size_t len2,
                               ...
                               size_t width)
{
    ...
    if (CMP(compare, carg, key, hintp) > 0) {
        ...
        lastOfs +=
            hint + 1;  // POP: we add 1 here so lastOfs stays non-negative
        ofs += hint;
    } else {  // key <= a[hint]
...
outer:
    ...
    if (len1 == 1) {
        ...
        ASSIGN(ELEM(dest, len2),
               cursor1);  //  Last elt of run 1 to end of merge
